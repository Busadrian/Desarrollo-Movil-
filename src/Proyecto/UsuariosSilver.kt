...
class UsuariosSilver : Usuarios {
        ...
        constructor(name: String, apellido: String, edad: Int, email: String, clave: String) : super(
            name, apellido, edad, email, clave)

        // Segundo Constructor
        constructor(name: String, apellido: String, edad: Int, email: String, clave: String, id: Int) : super(
            name, apellido, edad, email, clave, id)
